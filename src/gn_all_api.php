...
<!-- http://localhost/team/gn_all_api.php -->
...
<html>
    <head>
        ...
        <script>
            window.onload = function() {
                document.getElementById('frm_submit_gn1').onclick = function() {
                    // 공통
                    let obj = document.getElementById('frm_gn1');
                    obj.method = 'get';
                
                    // 평균거래금액
                    obj.action = 'gn_all_trade_df.php';
                    obj.target = 'ifr9';
                    obj.submit();

                    // 평당평균거래가
                    obj.action = 'gn_all_area_df.php';
                    obj.target = 'ifr10';
                    obj.submit();
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="gn_dong_api.php">All Result</a></li>
                            </ul>
                        </li>
                    </ul>          
                </div>      
                <form id='frm_gn1' style="margin-left: 150; margin-top:10;">
            목록 : 
            <select name="schAirportCode">
            <option value="GMP">강남구 전체 평당/평균 거래금액</option>
            <form id='frm_db1'>
            <input id='frm_submit_gn1' type='button' value='제출'>
        </form>
            </select>
            </div>
        ...
        <iframe name='ifr9' src='' style='margin-top:50px; margin-bottom:50px; padding-left:100px; width:700; height:600; border:none;'></iframe>
        <iframe name='ifr10' src='' style='margin-top:50px; margin-bottom:50px; padding-left:100px; width:700; height:600; border:none;'></iframe>
