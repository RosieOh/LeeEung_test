...
<body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">전체 위치 확인</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="program_map1.html">All Result</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4" style='padding-right:100px;'>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="mypage.html">My Page</a></li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">2022년 2학기 프로그램 호환 <br> 데이터분석 웹 대시보드 제작 프로젝트</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">구/동 별 부동산 실거래가 분석을 통한 내 집 시세 <br>알아보기</h2>
                    <div data-aos="fade-up" data-aos-delay="600">
                        <div class="text-center text-lg-start">
                            <a href="db_all_api.php" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; LeeEung_Website</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
