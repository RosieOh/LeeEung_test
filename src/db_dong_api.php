<!-- http://localhost/team/db_dong_api.php -->
...
<html>
    <head>
        ...
        <script>
            window.onload = function() {
                document.getElementById('frm_submit_db2').onclick = function() {
                    // 공통
                    let obj = document.getElementById('frm_db2');
                    obj.method = 'get';
                
                    // 평균거래금액
                    obj.action = 'db_dong_trade_df.php';
                    obj.target = 'ifr7';
                    obj.submit();

                    // 평당평균거래가
                    obj.action = 'db_dong_area_df.php';
                    obj.target = 'ifr8';
                    obj.submit();
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="db_all_api.php">서초구</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="db_dong_api.php">All Result</a></li>
                            </ul>
                        </li>
                    </ul>          
                </div>      
                <form id='frm_db2' style="margin-left: 150; margin-top:10;">
            목록 : 
            <select name="schAirportCode">
            <option value="GMP" href="db_all_area_df.php" >도봉구 동별 평당/평균 거래금액</option>
            <form id='frm_db1'>
            <input id='frm_submit_db2' type='button' value='제출'>
        </form>
            </select>
            </div>
        ...
        <iframe name='ifr7' src='' style='margin-top:50px; margin-bottom:50px; padding-left:100px; width:700; height:600; border:none;'></iframe>
        <iframe name='ifr8' src='' style='margin-top:50px; margin-bottom:50px; padding-left:100px; width:700; height:600; border:none;'></iframe>
