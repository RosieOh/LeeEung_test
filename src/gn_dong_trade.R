...
gn_dong_apt_price <- ggplotly(dong)

### 그래프 저장
htmlwidgets::saveWidget(gn_dong_apt_price,"./team_df/gn_dong_apt_price.html", selfcontained = F)

### 실행 - cmd 
# 1) 파일 위치 => cd C:\Apache24\htdocs\team
# 2) Rscript 위치 + R파일 => "C:/Program Files/R/R-4.2.2/bin/Rscript.exe" gn_dong_trade.R
