...
db_dong_apt_price_area <- ggplotly(dong_area)

### 그래프 저장
htmlwidgets::saveWidget(db_dong_apt_price_area,"./team_df/db_dong_apt_price_area.html", selfcontained = F)

### 실행 - cmd 
# 1) 파일 위치 => cd C:\Apache24\htdocs\team
# 2) Rscript 위치 + R파일 => "C:/Program Files/R/R-4.2.2/bin/Rscript.exe" db_dong_area.R
