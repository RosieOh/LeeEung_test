...
<!-- http://localhost/team/gn_dong_api.php -->
...
<html>
    <head>
        ...
        <script>
            window.onload = function() {
                document.getElementById('frm_submit_gn2').onclick = function() {
                    // 공통
                    let obj = document.getElementById('frm_gn2');
                    obj.method = 'get';

                    // 동별 평균거래금액
                    obj.action = 'gn_dong_trade_df.php';
                    obj.target = 'ifr11';
                    obj.submit();

                    // 동별 평당평균거래가
                    obj.action = 'gn_dong_area_df.php';
                    obj.target = 'ifr12';
                    obj.submit();
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                ...
                <form id='frm_gn2' style="margin-left: 150; margin-top:10;">
            목록 : 
            <select name="schAirportCode">
            <option value="GMP">강남구 동별 평당/평균 거래금액</option>
            <form id='frm_gn2'>
            <input id='frm_submit_gn2' type='button' value='제출'>
        </form>
            </select>
            </div>
        ...
        <iframe name='ifr11' src='' style='margin-top:50px; margin-bottom:50px; padding-left:100px; width:700; height:600; border:none;'></iframe>
        <iframe name='ifr12' src='' style='margin-top:50px; margin-bottom:50px; padding-left:100px; width:700; height:600; border:none;'></iframe>
