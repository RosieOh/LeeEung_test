...
<!-- http://localhost/team/seo_all_api.php -->
...
<html>
    <head>
        ...
        <script>
            window.onload = function() {
                document.getElementById('frm_submit_seo1').onclick = function() {
                    // 공통
                    let obj = document.getElementById('frm_seo1');
                    obj.method = 'get';
                
                    // 평균거래금액
                    obj.action = 'seo_all_trade_df.php';
                    obj.target = 'ifr1';
                    obj.submit();

                    // 평당평균거래가
                    obj.action = 'seo_all_area_df.php';
                    obj.target = 'ifr2';
                    obj.submit();
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                ...
                <form id='frm_seo1' style="margin-left: 150; margin-top:10;">
            목록 : 
            <select name="schAirportCode">
            <option value="GMP" href="db_all_area_df.php" >서초구 전체 평당/평균 거래금액</option>
            <form id='frm_seo1'>
            <input id='frm_submit_seo1' type='button' value='제출'>
        </form>
            </select>
            </div>
        ...
        <iframe name='ifr1' src='' style='margin-top:50px; margin-bottom:50px; padding-left:100px; width:700; height:600; border:none;'></iframe>
        <iframe name='ifr2' src='' style='margin-top:50px; margin-bottom:50px; padding-left:100px; width:700; height:600; border:none;'></iframe>
